...
คำสั่งเดียวจบ (เปิดทั้งฐานข้อมูล + เว็บ, Ctrl+C ปิดทั้งคู่):

```bash
npm run dev:all   # ครั้งแรกจะดาวน์โหลด binary Postgres + สร้างตาราง อัตโนมัติ
```

หรือแยก 2 เทอร์มินัลแบบเดิมก็ได้:
