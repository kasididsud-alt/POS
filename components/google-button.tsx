// ปุ่ม "เข้าสู่ระบบด้วย Google" — เป็นลิงก์ไป route ที่เริ่ม OAuth flow
// ใช้ <a> (ไม่ใช่ next/link) เพราะปลายทางเป็น route handler ที่ redirect ออกนอกแอป
export function GoogleButton({
  ...
  return (
    <a href={href} className="btn-outline w-full">
      <GoogleLogo />
      {label}
    </a>
  );
